...
export const quizData: QuizQuestion[] = [
    ...
    },
    {
        ...
        options: [
            { text: { uk: 'Рахав', ru: 'Рахав', en: 'Rahab' }, isCorrect: true, feedback: { uk: 'Вірно! Вона була блудницею, але через свою віру врятувала сім’ю і потрапила в родовід самого Ісуса. Справжній подарунок милості!', ru: 'Верно! Она была блудницей, но благодаря своей вере спасла семью и попала в родословную самого Иисуса. Настоящий подарок милости!', en: 'Correct! She was a harlot, but through her faith, she saved her family and entered the lineage of Jesus himself. A true gift of grace!' } },
